[![Build Status](https://travis-ci.org/reimersjc/code-kata-09.svg?branch=master)](https://travis-ci.org/reimersjc/code-kata-09)

# Code Kata 09

Implementation of the Checkout
[Code Kata](http://codekata.com/kata/kata09-back-to-the-checkout/).
